let
    ...
    GED = Fonte{[Item="GED",Kind="Sheet"]}[Data],

    // Converte em lista de listas
    Linhas = Table.ToRows(GED),
...
/*
    // =====================================================
    // CUSTO DE GED (aba 'GED') - VALIDAÇÃO
    // =====================================================
...
Antes de disponibilizar o arquivo para ingestão, validar:
 ...
 - Existe uma aba denominada exatamente GED.
 ...
 - Existe uma célula contendo exatamente o texto "CUSTO DE GED:".
 - O valor do custo deve estar na mesma linha do rótulo "CUSTO DE GED:", sendo considerado o primeiro valor preenchido à direita desse rótulo.
