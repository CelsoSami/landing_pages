let
    ...
    Pgto = Fonte{[Item="Pgto",Kind="Sheet"]}[Data],

    // Converte em lista de listas
    Linhas = Table.ToRows(Pgto),
...
/*
    // =====================================================
    // CUSTO DE PGTO (aba 'PGTO') - VALIDAÇÃO
    // =====================================================
...
Antes de disponibilizar o arquivo para ingestão, validar:
 ...
 - Existe uma aba denominada exatamente Pgto.
 ...
 - Existe uma célula contendo exatamente o texto "CUSTO DE PGTO:".
 - O valor do custo deve estar na mesma linha do rótulo "CUSTO DE PGTO:", sendo considerado o primeiro valor preenchido à direita desse rótulo.
