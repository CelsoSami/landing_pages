faça o mesmo com 'let
    ...
    Atualizacao = Fonte{[Item="Atualizacao",Kind="Sheet"]}[Data],

    // Converte em lista de listas
    Linhas = Table.ToRows(Atualizacao),
...
/*
    // =====================================================
    // CUSTO DE ATUALIZAÇÃO (aba 'Atualização') - VALIDAÇÃO
    // =====================================================
...
Antes de disponibilizar o arquivo para ingestão, validar:
 ...
 - Existe uma aba denominada exatamente Atualizacao.
 - Existe uma aba denominada exatamente $.
 - Existe uma célula contendo exatamente o texto "TABELA DE PREÇOS NO PERIODO".
 - Os serviços iniciam exatamente 4 linhas abaixo e 1 coluna à direita da célula "TABELA DE PREÇOS NO PERIODO".
 ...
 - Existe uma célula contendo exatamente o texto "CUSTO DE ATUALIZAÇÃO:".
 - O valor do custo deve estar na mesma linha do rótulo "CUSTO DE ATUALIZAÇÃO:", sendo considerado o primeiro valor preenchido à direita desse rótulo.
