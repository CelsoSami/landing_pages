let
    ...
    Protocolo = Fonte{[Item="Protocolo",Kind="Sheet"]}[Data],

    // Converte em lista de listas
    Linhas = Table.ToRows(Protocolo),
...
/*
    // =====================================================
    // CUSTO DE PROTOCOLO (aba 'Protocolo') - VALIDAÇÃO
    // =====================================================
...
Antes de disponibilizar o arquivo para ingestão, validar:
 ...
 - Existe uma aba denominada exatamente Protocolo.
 ...
 - Existe uma célula contendo exatamente o texto "CUSTO DE PROTOCOLO:".
 - O valor do custo deve estar na mesma linha do rótulo "CUSTO DE PROTOCOLO:", sendo considerado o primeiro valor preenchido à direita desse rótulo.
