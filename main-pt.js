document.addEventListener('DOMContentLoaded', () => {
    ...
    var typed = new Typed(".text", {
        strings: [
            ...
            "um Especialista em BI",
            "um Engenheiro de ML",
            "um Arquiteto de Dados",
            "um Entusiasta de IA"
        ],
        typeSpeed: 80,
        backSpeed: 50,
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            const subject = contactForm.querySelector('[name="subject"]').value || 'Contato via Portfolio';
            const message = contactForm.querySelector('[name="message"]').value;
            const body = `Nome: ${name}%0AEmail: ${email}%0A%0A${encodeURIComponent(message)}`;
